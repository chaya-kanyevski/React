...
const Sign = ({ onSignSuccess }: { onSignSuccess: Function }) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {            
          ...
          switch(status) {
              case 400:alert('User already exists in the system.');break;
    ...
    return (<>
        <Button 
            ...
            variant="outlined" 
            sx={{ backgroundColor: 'white', color: '#FFD5AD', border: `1px solid ${theme.palette.divider}`,marginRight: 2 }}>
            Register</Button>
        {clicked &&
          <Modal
            open={clicked}
            ...
            <Box sx={style}>
              <Typography id="modal-modal-title" variant="h6" component="h2">
                <form onSubmit={handleSubmit}>
                  <TextField type="text" fullWidth label="name" variant="outlined" inputRef={nameRef} />
